...
from Voting import Candidate, Ballot, test_tie, test_winner, run_voting, read_data
# -----------
# TestVoting
# -----------
...
class TestVoting(TestCase):
    ...
    def test_Ballot_1(self):
        ballot = Ballot("312")
        self.assertEqual(ballot.votes, ['3', '1', '2'])

    def test_Ballot_2(self):
        ballot = Ballot("12345")
        self.assertEqual(ballot.votes, ['1', '2', '3', '4', '5'])

    def test_Ballot_3(self):
        ballot = Ballot("54321")
        self.assertEqual(ballot.votes, ['5', '4', '3', '2', '1'])

    def test_Ballot_4(self):
        ballot = Ballot("713")
        self.assertEqual(ballot.votes, ['7', '1', '3'])

    def test_Ballot_5(self):
        ballot = Ballot("2818")
        self.assertEqual(ballot.votes, ['2', '8', '1', '8'])

    def test_Ballot_6(self):
        ballot = Ballot("456")
        self.assertEqual(ballot.votes, ['4', '5', '6'])

    def test_Ballot_7(self):
        ballot = Ballot("32849")
        self.assertEqual(ballot.votes, ['3', '2', '8', '4', '9'])
    ...
    def test_Ballot_9(self):
        ...
        self.assertEqual(ballot.votes, ['9', '8', '7', '6', '5', '4', '3', '2'])

    def test_Ballot_10(self):
        ballot = Ballot("246")
        self.assertEqual(ballot.votes, ['2', '4', '6'])
